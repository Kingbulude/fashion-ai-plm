...
SET company_id = '00000000-0000-0000-0000-000000000010',
    ...
    name = '品牌主理人',
    updated_at = now()
WHERE user_id = '19546527-536a-4e72-a033-4745a1ec2495';

-- 清除旧关联（避免重复执行产生脏数据）
DELETE FROM user_brands WHERE user_id = '19546527-536a-4e72-a033-4745a1ec2495';

-- 品牌主理人关联默认品牌 TEPNIX步戌
INSERT INTO user_brands (user_id, brand_id, role_level, created_at)
VALUES (
  '19546527-536a-4e72-a033-4745a1ec2495',
